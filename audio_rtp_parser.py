...
# Static variables for coloring CMD
RED_COLOR = '\033[91m'
GREEN_COLOR = '\033[92m'
NORMAL_COLOR = '\033[0m'

# Static variable to access layers in capture
LAYER_IP = 1
LAYER_RTP = 3
...
# Checking output folder existance
if not os.path.exists(audio_folder_path):
  os.makedirs(audio_folder_path)
  print('Audio output folder created')
...
try:
  ...
  print(RED_COLOR + 'Input PCAP file {} does not exist'.format(pcap_file_path,) + NORMAL_COLOR)
  exit()
